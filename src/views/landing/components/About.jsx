        ...
        <>
            <section className="w-full py-16 bg-transparent flex flex-col items-center">
                <div className="max-w-7xl mx-auto text-center px-4">
                    <h2 className="text-4xl font-bold text-[#8b9679] mb-4">About Us</h2>
                    <p className="text-lg text-[#496989] mb-8">
                        ...
                        {cardData.map((card, index) => (
                            <div key={index} className="p-4">
                                <div className="bg-white bg-opacity-70 shadow-lg rounded-[20px] p-8 m-4 flex flex-col items-center">
                                    ...
                                    <a href={card.link} className="mt-4 px-4 py-2 rounded-full bg-[#feba5b] hover:bg-blue-600 text-white">
                                        Learn More
                                    </a>
                                </div>
                            </div>
            ...
            <section className="py-5">
                <div className="container mx-auto px-4 flex flex-wrap">
                    ...
                    <div className="w-full md:w-1/2 flex flex-col justify-center">
                        <h2 className="text-3xl font-bold text-center text-[#b5bea5] mb-6">Advantages of Training at Creativehr</h2>
                        <div className="flex items-center mb-4">
                            <FaCheckCircle className="text-[#feba5b] text-2xl mr-4" />
                            <div>
                                <h3 className="text-2xl font-semibold text-[#feba5b]">Custom Training</h3>
                                <p className="text-[#496989]">Tailored sessions for your company's specific needs, ensuring optimal effectiveness.</p>
                            </div>
                        </div>
                        <div className="flex items-center mb-4">
                            <FaCheckCircle className="text-[#feba5b] text-2xl mr-4" />
                            <div>
                                <h3 className="text-2xl font-semibold text-[#feba5b]">Experienced Instructors</h3>
                                <p className="text-[#496989]">Receive guidance from industry experts with practical experience and deep knowledge.</p>
                            </div>
                        </div>
                        <div className="flex items-center mb-4">
                            <FaCheckCircle className="text-[#feba5b] text-2xl mr-4" />
                            <div>
                                <h3 className="text-2xl font-semibold text-[#feba5b]">Practical Approach</h3>
                                <p className="text-[#496989]">Focus on practical application with real case studies and simulations for deeper learning.</p>
                            </div>
                        </div>
                        <div className="flex items-center mb-4">
                            <FaCheckCircle className="text-[#feba5b] text-2xl mr-4" />
                            <div>
                                <h3 className="text-2xl font-semibold text-[#feba5b]">Ongoing Support</h3>
                                <p className="text-[#496989]">We provide ongoing support post-training to ensure successful implementation in the field.</p>
                            </div>
                        </div>
                    </div>
                </div>
